...
\begin{align}
G_3\brak{s}H_3\brak{s}&= \frac{20(s+3)}{s(s+1)(s+4)}
...
\begin{align}
G_4\brak{s}H_4\brak{s}&= \frac{100(s+5)}{s(s^2+4)(s+3)}
...
\begin{align}
G_5\brak{s}H_5\brak{s}&= \frac{k}{s(s+6)(s+9)}
...
\begin{align}
G_6\brak{s}H_6\brak{s}&= \frac{K(s+2)(s+4)}{s(s^2 - 3s +10)}
...
\begin{align}
G_7\brak{s}H_7\brak{s}&= \frac{k}{(s+1)(s+3)(s+5)(s+7)}
